...
Any algorithm for calculating volume will dealing with large data sets where the number of points $p$ in the point cloud is in the order of $10^6$. As such, the algorithms computation complexity must be taken into account.\\
