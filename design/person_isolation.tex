...
After the research conducted in Section \ref\{background subtraction and person isolation}.
...
The use of this skeleton meant that the group did not have to make use of computationally heavy computer vision algorithms to isolate a person, such as KDE or MOG as discussed in Section \ref{person_isolation:specific algorithms}.\\
